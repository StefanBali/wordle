...
//This is a copy of io.quarkus.test.mongodb.MongoTestResource except that "Version.Main.V4_0" was changed to "Version.Main.V5_0" and DEFAULT_PORT was adjusted.
public class Mongo5TestResource implements QuarkusTestResourceLifecycleManager {
    public static final String PORT = "port";
    private static final int DEFAULT_PORT = 27018;
    private static MongodExecutable MONGO;

    private static final Logger LOGGER = Logger.getLogger(Mongo5TestResource.class);
